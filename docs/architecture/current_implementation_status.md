...
Current active entries: **25 (`CS-SR-001` through `CS-SR-025`)**. The ledger intentionally remains blocking until each entry has correction evidence, independent review, and exact-tree certification.
