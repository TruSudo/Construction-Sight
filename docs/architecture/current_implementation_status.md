...
Current active entries: **37 (`CS-SR-001` through `CS-SR-037`)**. `CS-SR-028` through `CS-SR-035` record the eight P0 findings from the failed August 13 adversarial review; `CS-SR-036` records newly published pip advisory `PYSEC-2026-3721` discovered by exact-head CI #1056; and `CS-SR-037` records the exact-request-identity defect discovered during corrected-candidate adversarial verification of `1296b6053da3a5f30cbed702cc1333e9365bb307`. Corrections exist for `CS-SR-028` through `CS-SR-036`; the working `CS-SR-037` correction now sends one explicit request with client authentication disabled and request hooks denied. Every entry remains active until the complete corrected tree has correction evidence, a fresh independent review, and exact-tree certification.
