...
**Current draft-ledger status (September 20, 2026): 74 active entries (`CS-SR-001` through `CS-SR-074`), plus one separately missing Native Maximum Assurance artifact.** The historical August checkpoint below described a 38-entry ledger; it is not the current source of truth. The exact active-defect TOML in the present hardening branch is authoritative. Previously reported correction candidates do not close their associated entries automatically. `CS-SR-028` through `CS-SR-035` record the eight P0 findings from the failed August 13 adversarial review; `CS-SR-036` records newly published pip advisory `PYSEC-2026-3721` discovered by exact-head CI #1056; and `CS-SR-037` records the exact-request-identity defect discovered during corrected-candidate adversarial verification of `1296b6053da3a5f30cbed702cc1333e9365bb307`. Exact-head CI #1062 accepted that correction's ordinary gates, but continuing review exposed injected response-hook mutation as `CS-SR-038` against `ffaa745dea866dadc3d21e0272c6361128a80901`. Corrections exist for `CS-SR-028` through `CS-SR-036`; the `CS-SR-037` correction sends one explicit request with client authentication disabled and request hooks denied; the working `CS-SR-038` correction rejects configured response hooks before transport execution. Every entry remains active until the complete corrected tree has correction evidence, a fresh independent review, and exact-tree certification.
