...
| CS-PLAN-002 | Verified recurring live adapters | CEQAnet remains `partial`; a digest-bound policy now permits only explicit one-request, zero-retry official-CSV evidence runs through 2026-08-13. HTML automation, production scheduling, persistence, and promotion remain unauthorized. | Collect and independently verify at least four observations across three UTC dates and both project and document exports before another maturity review. |
