...
Assurance-covered tree identity is recomputed directly from the reviewed commit using canonical Git object identity/finalization exclusions and compared against both retained reviewed-tree identity and current covered tree.
