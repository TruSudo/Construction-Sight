# CS-SR-041 Permanent Closure Evidence

## Resolution

ArcGIS acquisition enforces response ceilings during bounded streaming and rejects declared-length or chunked oversize responses before retaining incomplete bodies as successful evidence.
