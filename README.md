...
- Draft PR #117 is not certified. The August 13 adversarial review invalidated candidate `4cc3ce763354ea91ef8c4bed28c3ce0b531379c3`; exact-head CI #1056 later discovered `PYSEC-2026-3721`, and corrected-candidate adversarial verification exposed `CS-SR-037` against `1296b6053da3a5f30cbed702cc1333e9365bb307`. Exact-head CI #1062 accepted the `CS-SR-037` correction's ordinary gates, but continuing adversarial verification exposed response-hook evidence mutation as `CS-SR-038` against `ffaa745dea866dadc3d21e0272c6361128a80901`. The active ledger now contains 38 defects (`CS-SR-001` through `CS-SR-038`) that block review, readiness, and merge.
- Remediation remains implemented for `CS-SR-028` through `CS-SR-036`, and the working correction for `CS-SR-037` constructs one explicit request outside injected-client defaults, disables client authentication, and rejects request hooks before execution. Candidates `1296b6053da3a5f30cbed702cc1333e9365bb307` and `ffaa745dea866dadc3d21e0272c6361128a80901` remain invalidated; the working `CS-SR-038` correction rejects response hooks before transport execution, and all 38 entries remain active until a successor tree passes a fresh exact-head matrix and independent adversarial review.
