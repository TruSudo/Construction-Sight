...
- Remediation remains implemented for `CS-SR-028` through `CS-SR-036`, but `CS-SR-037` has no accepted correction and invalidates candidate `1296b6053da3a5f30cbed702cc1333e9365bb307`. All 37 entries deliberately remain active until a newly corrected complete tree passes a fresh exact-head matrix and independent adversarial review.
