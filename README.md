...
- Working-candidate remediation is implemented for `CS-SR-028` through `CS-SR-036`. All 36 entries deliberately remain active until the complete corrected tree passes a fresh exact-head matrix and independent adversarial review.
