...
def test_mutation_runner_loads_assurance_overlay_as_one_unique_case_set() -> None:
    ...
    assert {
        ...
        "CS-MUT-ASSURANCE-GITHUB-ACTIONS-BINDING-001",
        "CS-MUT-ASSURANCE-GITHUB-ACTIONS-COMMIT-001",
        "CS-MUT-ASSURANCE-GITHUB-ACTIONS-PR-001",
        "CS-MUT-ASSURANCE-GITHUB-ACTIONS-REPOSITORY-001",
        "CS-MUT-ASSURANCE-GITHUB-ACTIONS-STEP-001",
        "CS-MUT-ASSURANCE-PREFLIGHT-FILTER-001",
