...
def _provenance_for_record(record: dict[str, Any]) -> Provenance:
    ...
    has_human_title = bool(record.get("has_human_title"))
    enrichment_status = _string_or_none(record.get("enrichment_status"))
    confidence_score = 90 if has_human_title and enrichment_status == "enriched" else 75
