...
class IntelligenceGraphService:
    ...
    def upsert_entity(self, entity: EntityIdentity) -> EntityIdentity:
        """Persist an entity identity and emit an entity-created event."""
        ...
        self._emit_event(
            ...
            message=f"Entity recorded: {entity.canonical_name}.",
    ...
    def upsert_relationship(self, relationship: RelationshipAssertion) -> RelationshipAssertion:
        ...
        self._emit_event(
            ...
            event_type=RuntimeEventType.RELATIONSHIP_CREATED,
            severity=RuntimeEventSeverity.HIGH,
            message=f"Relationship recorded: {relationship.predicate}.",
    ...
    def upsert_project_cluster(self, cluster: ProjectCluster) -> ProjectCluster:
        ...
        self._emit_event(
            ...
            severity=RuntimeEventSeverity.HIGH,
            message=f"Project cluster recorded: {cluster.project_name or cluster.project_cluster_id}.",
    ...
    def upsert_opportunity(self, opportunity: OpportunitySignal) -> OpportunitySignal:
        ...
        self._emit_event(
            ...
            severity=RuntimeEventSeverity.MEDIUM,
            message=f"Opportunity signal recorded: {opportunity.category.value}.",
