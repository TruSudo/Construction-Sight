...
AUTHORIZATION_SCHEMA_VERSION: Final[Literal["parcel-arcgis-bulk-rehearsal-authorization/v1"]] = (
    "parcel-arcgis-bulk-rehearsal-authorization/v1"
)
PREFLIGHT_SCHEMA_VERSION: Final[Literal["parcel-arcgis-bulk-rehearsal-preflight/v1"]] = (
    "parcel-arcgis-bulk-rehearsal-preflight/v1"
)
_AUTHORIZATION_STATEMENT: Final[Literal["authorize one complete read-only ArcGIS rehearsal"]] = (
