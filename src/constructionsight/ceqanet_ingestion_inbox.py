...
class CeqanetIngestionInbox(BaseModel):
    ...
    limitations: list[str] = Field(
        default_factory=lambda: [
            ...
            "verify location.",
            "This inbox performs no remote collection, persistence mutation, lead qualification, "
            "outreach, or bidding.",
            "Each pending candidate still requires separate current lawful-access review and "
            "capture authorization.",
            "Any import still requires independent approval of the exact source and write-plan "
            "digests.",
        ]
    )
